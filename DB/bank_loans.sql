...
CREATE TABLE `loans` (
  ...
  `emi` decimal(50,2) NOT NULL,
  `status` enum('0','1','2') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `loans_user_id_foreign` (`user_id`),
  KEY `loans_loan_detail_id_foreign` (`loan_detail_id`),
  CONSTRAINT `loans_loan_detail_id_foreign` FOREIGN KEY (`loan_detail_id`) REFERENCES `loan_details` (`id`) ON DELETE CASCADE,
...
INSERT INTO `loans` VALUES (11,1,3,'137bGsDos20223',10000000.00,3333333.33,'1','2022-11-26 10:06:46','2022-11-27 04:27:34');
